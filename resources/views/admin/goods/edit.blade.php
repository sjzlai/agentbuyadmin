               ...
               <div class="tpl-form-body tpl-form-line">
                   <form action="{{url('admin/power/goods/store')}}" method="post" class="am-form tpl-form-line-form" enctype="multipart/form-data">
                       ...
                       <div class="am-form-group">
                           ...
                           <div class="am-u-sm-9">
                               @if($goodsIdList)
                                   <input type="text" class="tpl-form-input" id="user-display_name" name="title" value="{{$goodsIdList->title}}" placeholder="请输入商品名称">
                               @else
                       ...
                       <div class="am-form-group" >
                           ...
                           <div class="am-u-sm-9">
                               @if($goodsIdList)
                               {{--@php echo htmlspecialchars_decode($goodsIdList->content);@endphp--}}
                                   <script id="container" name="content" type="text/plain" >
                                       {{--@php--}}
                                         {{--echo html_entity_decode($goodsIdList->content);--}}
                                       {{--@endphp--}}
                                       {!! $goodsIdList->content !!}
                                   </script>
                               @else
                       ...
                       <div class="am-form-group">
                           ...
                           <div class="am-u-sm-9">
                               @if($goodsIdList)
                                   <input type="text" class="tpl-form-input" id="user-description" name="number" value="{{$goodsIdList->number}}" placeholder="">
                               @else
                       ...
                       <div class="am-form-group">
                           ...
                           <div class="addImages am-u-sm-9">
                               ...
                               <input type="file" class="file"  name="file1" accept = "image/*" style="" >
                               <img src="{{$goodsIdList->image1}}" alt=""><i class="far fa-times-circle close"></i>
                           </div>
                       </div>
                       <div class="am-form-group">
                           ...
                           <div class="addImages am-u-sm-9">
                               ...
                               <input type="file" class="file"  name="file2" accept = "image/*"  style="" >
                               <img src="{{$goodsIdList->image2}}" alt=""><i class="far fa-times-circle close"></i>
                           </div>
                       </div>
                       <div class="am-form-group">
                           ...
                           <div class="addImages am-u-sm-9">
                               ...
                               <input type="file" class="file"  name="file3" accept = "image/*"  style="" >
                               <img src="{{$goodsIdList->image3}}" alt=""><i class="far fa-times-circle close"></i>
                           </div>
                       </div>
                       <div class="am-form-group">
                           ...
                           <div class="addImages am-u-sm-9">
                               ...
                               <input type="file" class="file"  name="file4" accept = "image/*"  style="" >
                               <img src="{{$goodsIdList->image4}}" alt=""><i class="far fa-times-circle close"></i>
                           </div>
                       </div>
                       <div class="am-form-group">
                           ...
                           <div class="addImages am-u-sm-9">
                               ...
                               <input type="file" class="file"  name="file5" accept = "image/*"  style="" >
                               <img src="{{$goodsIdList->image5}}" alt=""><i class="far fa-times-circle close"></i>
                           </div>
                       </div>
