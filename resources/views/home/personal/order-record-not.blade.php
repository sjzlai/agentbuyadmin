...
@section('content')
    ...
    <section id="shopping_record">
            ...
            <div class="personal_right">
                ...
                <div class="shopping_record">
                    <div class="record_title">
                        <div class="record_all"><a href="{{url('/order-record')}}" class="">全部订单</a></div>
                        <div class="record_had"><a href="{{url('/order-finish')}}" class="">已完成订单</a></div>
                        <div class="record_none"><a href="{{url('/order-not')}}" class="active">未完成订单</a></div>
                        {{--订单的检索--}}

                        <div class="record_search">
                            <form action="{{url('/order-not')}}" method="post">
                                {!! csrf_field() !!}
                                <div>
        ...
        {{--</div>--}}
                    ...
                    <div class="am-cf">
                        <div class="am-fr">
                            {{ $notFinish->appends(['order_number' =>old('order_number')])->links() }}
